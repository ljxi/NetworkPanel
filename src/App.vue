    ...
    <el-header class="header">
      <div style="margin-top: 15px;">
        <div style="width: fit-content;float: left;">
          <svg
            style="display:inline-block;vertical-align: -12px;width: 40px;height: 40px;"
            t="1702892592527" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
              ...
              fill="rgb(80,170,255)" p-id="4461"></path>
          </svg>
